      ...
      <AnimatePresence>
        {showQuickConfig && selectedProject && (
          <motion.div
            ...
            onClick={() => {
              void storageService.updateProject(selectedProject.id!, selectedProject);
          ...
          >
            ...
            >
                ...
                <button
                  ...
                  onClick={() => {
                    const newFields = [
                      ...
                      { name: '', value: '', showInPhoto: true, active: true },
                    ];
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 flex gap-2">
                        ...
                        <input
                          ...
                          className="bg-white px-2 py-1.5 rounded-lg font-mono text-[11px] w-16 shrink-0 shadow-sm border border-gray-100 outline-none"
                          placeholder="CANT"
                        />
                      </div>
                      <button
                        ...
                        className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${
                          cf.active !== false ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-400'
                        }`}
                      >
              ...
              <button
                ...
                className="w-full py-5 bg-gray-950 text-white rounded-[2rem] text-[13px] font-black uppercase tracking-widest active:scale-95"
              >
                Volver a Cámara
              </button>
            </motion.div>
